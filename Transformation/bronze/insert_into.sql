/*
========================================================================
Stored Procedure: Load bronze layer tables (*.csv -> bronze.tables)
========================================================================
Script purpose:
	This stored procedure performs the ETL (Extract, Transform, load) process to
	populate the 'bronze' schema tables from *.csv files.
...
Note: 
  @filePath should be changed accordingly with your csv files path.
